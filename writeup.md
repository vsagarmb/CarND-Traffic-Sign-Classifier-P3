...
* The size of training set before Augmentation is - 34799
![image5]
...
Here is an exploratory visualization of the data set. It is a view of one image per label in the dataset

![alt text][image1]

To increase the number of availbale samples I used image augmentation techniques. This increased the sample size by 11681 images to make sure that each of the label type has atleast 800 samples. I chose this number arbitarily. 
